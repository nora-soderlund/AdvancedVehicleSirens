...
std::map<int, bool> VehicleLights::states;

std::map<int, std::map<VehicleLightState, std::vector<VehicleMaterial*>>> VehicleLights::materials;
std::map<int, std::map<VehicleLightState, std::vector<VehicleDummy*>>> VehicleLights::dummies;
