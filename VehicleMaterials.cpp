...
std::vector<VehicleMaterialFunction> VehicleMaterials::functions;
std::vector<VehicleMaterialRender> VehicleMaterials::renders;
std::vector<VehicleDummyFunction> VehicleMaterials::dummy;

std::map<int, std::map<RpMaterial*, bool>> VehicleMaterials::materials;
std::map<int, std::map<RwFrame*, bool>> VehicleMaterials::frames;
std::map<int, bool> VehicleMaterials::dummies;

CVehicle* VehicleMaterials::currentVehicle;
...
std::list<std::pair<unsigned int*, unsigned int>> VehicleMaterials::storedMaterials;
